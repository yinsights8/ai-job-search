---
description: "Scan Gmail (read-only) and archive recruiter emails. Flags: --since YYYY-MM-DD, --company <name>, --dry-run, --limit N, --llm-base-url <url>, --llm-model <name>"
---
...
Spawn the `email-scanner` subagent (see `.opencode/agents/email-scanner.md`).
Pass:
...
| `.opencode/agents/email-scanner.md` | Subagent spec. |
