...
Dispatch parallel `general-purpose` agents via the **Task tool**, ~5 jobs per agent (a single agent is fine for ≤5 jobs). Token-efficiency rules, consistent with `/apply`:
